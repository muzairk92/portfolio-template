...
If you just want to see the hero before touching the React/Vite toolchain, open [`preview.html`](./preview.html) directly in your browser. It contains the same markup/CSS/GSAP timeline as the React components along with a lightweight script for the theme toggle, so you can evaluate the design and animation without installing dependencies.
